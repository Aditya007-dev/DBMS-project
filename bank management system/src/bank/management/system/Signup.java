...
public class Signup extends JFrame implements ActionListener{
	...
	add(dateChooser);
        ...
        t5.setBounds(300,430,400,30);
        add(t5);
        
        l11.setBounds(100,480,200,30);
        add(l11);
        
        t6.setBounds(300,480,400,30);
        add(t6);
        
        l12.setBounds(100,530,200,30);
        add(l12);
        
        t7.setBounds(300,530,400,30);
        add(t7);
        
        b.setBounds(620,580,80,30);
        add(b);
